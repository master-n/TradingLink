        ...
        <div class="col-lg-12">
          <div class="table-wrapper2">
            ...
            <table class="eg-table table job-list-table mb-0">
              ...
              <tbody>
              <tr v-for="(tradesperson,i) in tradespeople" :key="i">
                <td>
                  <div class="job-content">
                    <h5>{{ tradesperson.name }}</h5>
                  </div>
                </td>
                <td>
                ...
                <td>
                  <span class="total-number light-orange">{{ tradesperson.phone }}</span>
                </td>
                <td>
                  <span class="total-number">{{ tradesperson.city_name }}</span>
                </td>
                <td>
...
<!--                    <li><a href="job-details-for-company.html" class="primry-btn-2  eg-btn green&#45;&#45;btn">-->
