                ...
                <div class="col-lg-12 mb-30">
                  <div class="job-listing-card">
                    <div class="job-top">
                      <div class="job-list-content">
                        <div class="company-area">
                          <div class="company-details">
                            <div class="name-location">
                              <h5><a href="job-details.html">Re-Set a Shower Tray in cubicle </a></h5>
                              <p><i class="bi bi-pin-map"></i> Cirencester (10 miles)</p>
                            </div>
                          </div>
                        </div>
                        <div class="job-discription">
                          <ul>
                            <li>
                              <p> <span class="time"> <i class="bi bi-tools"></i> Bathroom Fitting</span></p>
                            </li>
                            <li>
                              <p><span class="time"> <i class="bi bi-clock"></i> 4 days ago</span></p>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div class="job-type-apply">
                      <div class="job-type">
                        <span class="light-green">Repeat customer</span>
                      </div>
                      <div class="apply-btn">
                    ...
                    <div class="job-top">
                      <div class="job-list-content">
                        <div class="company-area">
                          <div class="company-details">
                            <div class="name-location">
                              <h5><a href="job-details.html">Connecting loo, bidet, basin and radiators</a></h5>
                              <p><i class="bi bi-pin-map"></i> Cirencester (10 miles)</p>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="job-top">
                      <div class="job-list-content">
                        <div class="company-area">
                          <div class="company-details">
                            <div class="name-location">
                              <h5><a href="job-details.html">Bathroom update</a></h5>
                              <p><a href="company-details.html">UI.UX Company</a></p>
                            </div>
                          </div>
                        </div>
                        <div class="job-discription">
                    ...
                    <div class="job-top">
                      <div class="job-list-content">
                        <div class="company-area">
                          <div class="company-details">
                            <div class="name-location">
                              <h5><a href="job-details.html">Bathroom vinyl fitting</a></h5>
                              <p><a href="company-details.html">UI.UX Company</a></p>
                            </div>
                          </div>
                        </div>
